...
Public Class Administrador
    ...
    Private Sub updateGridArticulos()
        ...
        Try
            ...
            cmd.CommandText = "SELECT articulos.id,articulos.Nombre,articulos.Precio,articulos.portada,articulos.stock,usuario.username As vendedor FROM articulos,usuario  WHERE articulos.usuario_id = usuario.id AND articulos.deleted=0"
